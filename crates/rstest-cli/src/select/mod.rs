...
pub use coverage::{
    affected_with_coverage, coverage_index_stamp, load_coverage_index_written_since,
    mapped_test_count, CoverageFile, CoverageIndex, COVERAGE_INDEX_FILE, COVERAGE_INDEX_SCHEMA,
};
