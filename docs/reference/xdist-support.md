...
- [Compatibility](../concepts/compatibility.md): the `-n 0` byte-exact contract, the measured battery, and the known-gaps table (incl. xdist controller-side hooks).
