...
| django-allauth | 2,050 | 22s | 8s (`-n 8`) | **8s** (`-n 4`) | 100% on the measured run (flaky under pytest too) |
| rich | 981 | 3.4s | 2.8s | **2.5s** (`-n 4`) | 100% on the measured run (flaky under pytest too) |
<!-- --8<-- [end:suite-table] -->
